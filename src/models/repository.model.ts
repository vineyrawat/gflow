...
export class Convert {
  public static toRepository(json: string): Repository {
    return cast(JSON.parse(json), r("Repository"));
  }

  public static repositoryToJson(value: Repository): string {
    return JSON.stringify(uncast(value, r("Repository")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Permissions: o(
    [
      { json: "admin", js: "admin", typ: u(undefined, true) },
      { json: "maintain", js: "maintain", typ: u(undefined, true) },
      { json: "push", js: "push", typ: u(undefined, true) },
      { json: "triage", js: "triage", typ: u(undefined, true) },
      { json: "pull", js: "pull", typ: u(undefined, true) },
    ],
    false
  ),
};
